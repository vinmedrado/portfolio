...
const PROJECTS = [
  {
    ...
    track: "dados",
    pill: "Data / ML / Quant",
    category: "Finance, Investing & Quantitative Research",
    year: "2026",
    ...
    results: [
      ...
      "Causal backtesting and Walk-Forward Validation, with a Research Engine (Monte Carlo, bootstrap, sensitivity analysis)"
    ],
    completedFeatures: [
      ...
      "Explanation Engine",
      "Audit Trail (decision_id / correlation_id)",
      "Feature Store V2",
      "Target Engine V2",
      "ML Engine V2",
      ...
      "Paper Trading V2",
      "Canonical QA (629 tests)",
      "Security Hardening"
    ],
    roadmap: [
      "Financial Autopilot (planned)",
      "Research Engine expansion",
  ...
  },
  {
    ...
    year: "2025",
    status: "Public demo (synthetic scenario) · real OAuth2 integration",
  ...
  },
  {
    ...
    year: "2025",
    status: "Public demo · realtime websocket",
  ...
  },
  {
    ...
    year: "2026",
    status: "Static demo · GitHub Pages",
